 ...
 */
class Tale_Travel_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Tale_Travel_Dropdown_Category_Control extends WP_Customize_Control {
...
class Tale_Travel_Note_Control extends WP_Customize_Control {
...
class Tale_Travel_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Tale_Travel_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="tale-travel-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Tale_Travel_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Tale_Travel_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="tale-travel-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'tale-travel' ); ?>" class="tale-travel-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Tale_Travel_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
