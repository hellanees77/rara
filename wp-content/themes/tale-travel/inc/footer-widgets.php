...
class Tale_Travel_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'tale_travel';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'tale-travel' ), $i ),
...
// Initialize.
$tale_travel_footer_widgets = new Tale_Travel_Footer_Widgets();
