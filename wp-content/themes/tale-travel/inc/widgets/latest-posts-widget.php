...
if ( ! class_exists( 'Tale_Travel_Latest_Post' ) ) :

     
    class Tale_Travel_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'tale-travel' ),
            );
            parent::__construct( 'tale_travel_latest_post', esc_html__( 'TP : Latest Posts', 'tale-travel' ), $tp_widget_popular_post );
        }
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'tale-travel' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>
